...
function getFullPageWithFolder() {
    ...
    var match = wl.pathname + wl.hash + wl.search;
    
    // index page
    if (wl.pathname === options.INDEX_PAGE || wl.pathname === options.INDEX_PATH) {
        // is /folder/index.html or /folder/
        return options.INDEX_PATH + options.HOME_PAGE;
    } else {
        /*
