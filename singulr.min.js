...
c;else if(void 0===c)f.getElementById(a).innerHTML=b.responseText;else throw Error("Invalid callback return!");}else 404===b.status&&n(g.PAGE_404);g.onDocumentLoaded();u(p,function(){p=[];g.onPageLoaded();y()})};b.send()}function z(a,c){var d=f.createElement("script");d.async=1;d.onload=d.onreadystatechange=function(){c();d.parentNode.removeChild(d)};d.src=a;f.getElementsByTagName("body")[0].appendChild(d)}function u(a,c){0<a.length&&v(0,a,c||function(){})}function v(a,c,d){"src"===c[a][0]?z(c[a][1],
function(){void 0!==c[a+1]?v(a+1,c,d):d()}):"code"===c[a][0]&&(k.eval.call(k,c[a][1]),void 0!==c[a+1]?v(a+1,c,d):d())}function m(a){if(void 0===a||null===a)console.warn("No node provided!");else{if(null===a.parentNode)throw Error("Node has been already removed");q.push(a)}}function w(){for(var a=0;a<q.length;a++){var c=q[a];c.parentNode.removeChild(c)}q=[]}function A(a,c){function d(){!b&&c&&(b=!0,c.call(a))}var b;a.addEventListener&&a.addEventListener("load",d);a.attachEvent&&a.attachEvent("onload",
d);if("isApplicationInstalled"in navigator&&"onloadcssdefined"in a)a.onloadcssdefined(d)}var r="",l=[],q=[],p=[],g={onDocumentLoaded:function(){},onPageLoaded:function(){},onDependenciesLoaded:function(){},analyticNodes:[],HOME_PAGE:"home.html",BASE_PAGE:"base.html",PAGE_404:"404.html",PAGE_ID:"page",CONTENT_ID:"content",dependencies:{javascript:[],css:[]}};k.Singulr={init:function(a){if(void 0!==a)for(var c in a)a.hasOwnProperty(c)&&void 0!==g[c]&&(g[c]=a[c]);a=[];for(c=0;c<g.dependencies.javascript.length;c++)a.push(["src",
g.dependencies.javascript[c]]);u(a,function(){for(var a=g.dependencies.css,b=[],c,f=0;f<a.length;f++)c=B(a[f]),A(c,function(){b[a]=!0;for(var a=0;a<b.length;a++)if(!1===b[a])return;g.onDependenciesLoaded();x(g.PAGE_ID,g.BASE_PAGE,function(){var a=k.location.href.substr(k.location.href.lastIndexOf("/")+1),a=a.substr(a.indexOf("?")+1),a=decodeURIComponent(a);k.history.replaceState({},"",a);console.log("curFullPageUrl: "+a);console.warn(Error().stack);0<a.length?t(a):n(g.HOME_PAGE)})})})},getPage:function(){return k.location.href.lastIndexOf("/")===
k.location.href.length-1?"/"+g.HOME_PAGE:k.location.href.match(/[^\/](\/[\w\%\-\_]+(\.[a-zA-Z]+)?)+.*$/)[0].substr(1)},loadPage:t};var B=function(a,c,d){function b(a){if(g.body)return a();setTimeout(function(){b(a)})}function f(){e.addEventListener&&e.removeEventListener("load",f);e.media=d||"all"}var g=k.document,e=g.createElement("link"),h;if(c)h=c;else{var l=(g.body||g.getElementsByTagName("head")[0]).childNodes;h=l[l.length-1]}var n=g.styleSheets;e.rel="stylesheet";e.href=a;e.media="only x";b(function(){h.parentNode.insertBefore(e,
c?h:h.nextSibling)});var m=function(a){for(var b=e.href,c=n.length;c--;)if(n[c].href===b)return a();setTimeout(function(){m(a)})};e.addEventListener&&e.addEventListener("load",f);e.onloadcssdefined=m;m(f);return e}})(document,window);
