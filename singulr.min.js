...
d[a])return;f=!0;e&&c()})},getPage:function(){var a=k.location,c=a.pathname+a.hash+a.search;return a.pathname===h.INDEX_PAGE||a.pathname===h.INDEX_PATH?h.INDEX_PATH+h.HOME_PAGE:c},loadPage:v};var E=function(a,c,b){function e(a){if(d.body)return a();setTimeout(function(){e(a)})}function f(){g.addEventListener&&g.removeEventListener("load",f);g.media=b||"all"}var d=k.document,g=d.createElement("link"),h;if(c)h=c;else{var m=(d.body||d.getElementsByTagName("head")[0]).childNodes;h=m[m.length-1]}var p=
