...
k.history.replaceState({},"",a);console.log("curFullPageUrl: "+a);0<a.length&&"index.html"!==a?t(a):p(g.HOME_PAGE)})}if(void 0!==a)for(var b in a)a.hasOwnProperty(b)&&void 0!==g[b]&&(g[b]=a[b]);A();var e=!1,d=!0;b=[];for(a=0;a<g.dependencies.javascript.length;a++)b.push(["src",g.dependencies.javascript[a]]);u(b,function(){e=!0;d&&c()});b=g.dependencies.css;var h=[],f;for(a=0;a<b.length;a++)f=D(b[a]),C(f,function(){h[a]=!0;for(var a=0;a<h.length;a++)if(!1===h[a])return;d=!0;e&&c()})},getPage:function(){return"index.html"===
k.location.pathname.substr(k.location.pathname.lastIndexOf("/")+1)||"/"===k.location.pathname.charAt(k.location.pathname.length-1)?"/"+g.HOME_PAGE:k.location.href.match(/[^\/](\/[\w\%\-\_]+(\.[a-zA-Z]+)?)+.*$/)[0].substr(1)},loadPage:t};var D=function(a,c,b){function e(a){if(h.body)return a();setTimeout(function(){e(a)})}function d(){f.addEventListener&&f.removeEventListener("load",d);f.media=b||"all"}var h=k.document,f=h.createElement("link"),g;if(c)g=c;else{var m=(h.body||h.getElementsByTagName("head")[0]).childNodes;
g=m[m.length-1]}var p=h.styleSheets;f.rel="stylesheet";f.href=a;f.media="only x";e(function(){g.parentNode.insertBefore(f,c?g:g.nextSibling)});var n=function(a){for(var b=f.href,c=p.length;c--;)if(p[c].href===b)return a();setTimeout(function(){n(a)})};f.addEventListener&&f.addEventListener("load",d);f.onloadcssdefined=n;n(d);return f}})(document,window);
